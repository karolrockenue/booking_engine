...
### Remaining
- **Phase 3 — Mews reads:** room categories, rates, availability, pricing → `mews_*` tables + `getAvailability` so a Mews storefront shows rooms.
