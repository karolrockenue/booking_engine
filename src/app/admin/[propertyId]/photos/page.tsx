...
type Slot = "hero" | "gallery" | "room" | "neighbourhood";
...
export default function PhotosPage() {
  ...
  const groups = useMemo(() => {
    ...
    return { hero, gallery, neighbourhood, byRoom };
  }, [photos]);
    ...
    <>
      <TopStrip
        ...
        subtitle={
          loading
            ? "Loading…"
            : `${photos.length} photo${photos.length === 1 ? "" : "s"} · hosted on Cloudflare R2 · ${formatBytes(totalBytes)} total`
        }
        actions={
          <UploadButton
        ...
        >
          ...
          {showMenu && (
            ...
            >
              ...
              {(["hero", "gallery", "room", "neighbourhood"] as Slot[]).map((s) => (
                <button
                  key={s}
